...
const Apply = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    toast.success(
      "We have received your order, We will contact you within 24 hours. Thank You!"
    );
  };
  ...
  return (
    <>
      ...
      <div className="absolute w-full h-screen md:bg-home-background bg-[#3addf6] bg-center  flex flex-row items-stretch bg-cover overflow-hidden ">
        <Head>
            ...
            <div>
              ...
              <form onSubmit={handleSubmit}>
                <div className="w-[90%] mx-auto flex flex-col font-poppins my-2">
                  <span className="text-md text-white font-semibold my-2">
                ...
                <div className="w-[90%] mx-auto flex items-center font-poppins my-2">
                  ...
                  />
                  <span className="text-md text-white font-regular my-2">
                    Yes
                  </span>
                ...
                <div className="w-[90%] mx-auto flex flex-col font-poppins my-2">
                  <span className="text-md text-white font-semibold my-2">
                    Quantity (1 REC NFT = 1kWh Unit on your electricity bill) *
                  </span>
                  <input
                    className="bg-[#68CAF1] p-2 text-md placeholder:text-white text-white font-regular rounded-md border-[#E3E3E3] border-solid border-[2px] flex flex-col items-start outline-none"
                    type="number"
                ...
                <div className="w-[90%] mx-auto flex flex-col items-start font-poppins my-2">
                  ...
                  <div className="w-full flex flex-col md:flex-row items-center justify-between">
                    <div className="w-full flex items-center my-1">
                      ...
                      />
                      <span className="text-md text-white font-regular md:ml-2">
                        Recurring Purchase
                      </span>
                    </div>
                    <div className="w-full flex items-center my-1">
                ...
                <div className="w-[90%] mx-auto flex justify-center items-center text-xl font-poppins">
                  <button
                    type="submit"
                    className="w-full self-center bg-[#0e7490] px-2 py-2 rounded-md text-centers border-none outline-none cursor-pointer text-[#04A6E7] font-semibold mt-3.5 mb-5 transition delay-500 ease hover:-translate-y-2 active:translate-y-4"
                  >
                    Submit
                  </button>
                </div>
