                    ...
                    <div className='w-full p-6 flex flex-col h-full overflow-x-hidden overflow-y-auto scroll-smooth hover:scroll-auto custom-scrollbar'>
                        ...
                        <div>
                            ...
                            <div className='w-full flex flex-col font-poppins'>
                                ...
                                >
                                    Hashcase Carbon Credits TREE&nbsp;&nbsp;<Image src='/images/23901.png' alt="sample nft" width={40} height={40} style={{objectFit:'contain'}}/>
                                </span>
                            </div>
                            ...
                            <div className="w-full flex flex-col my-4 ">
                                <img src='/images/23901.png' alt="sample nft" className="md:w-[50%] w-[85%]" style={{'margin':'0 auto', borderRadius:'0.75rem'}} />
                            </div>
