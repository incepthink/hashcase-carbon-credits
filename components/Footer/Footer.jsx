...
import SampleImage from "../../public/images/hashcaselogo.png";
...
const Footer = () => {
  ...
  const sendMail = () => {
    if (msg != "") {
      const mailto =
        "mailto:contact@tokere.com?body=" + encodeURIComponent(msg);
  ...
  return (
    <div className="max-w-screen    flex text-white bg-[#04A6E7]  flex-col font-poppins">
      <div className="hidden md:flex flex-row justify-between items-center">
        <Link
          className="flex items-center  px-12 py-2 text-xl font-semibold "
          href="/"
        >
          <Image
            width={130}
      ...
      <Link
        className="md:hidden flex justify-center items-center bg-[#00000033] px-12 py-6 text-2xl font-semibold "
        href="/"
      >
        <Image
          width={130}
      ...
      <div className="flex md:flex-row flex-col justify-around  p-6 font-poppins">
        <div className="flex flex-col  md:w-[20%] w-[100%]">
          <div className="flex flex-row my-2">
            <div className="rounded-full p-4 bg-[#111C55] items-center">
        ...
        <div className="flex  md:w-[40%] w-[100%] md:flex-row flex-col  md:center center text-white">
          <Link href="/nfts" className=" font-normal text-xl m-2">
            Claim NFT
          </Link>
          <Link href="/faq" className="font-normal text-xl m-2">
            FAQs
          </Link>
        </div>
        <div className="flex flex-col md:w-[25%] w-[100%] text-white">
          <input
            ...
            className="outline-none border-white rounded-md border-2 w-[80%] mx-auto bg-transparent text-white placeholder-white px-6 py-4"
