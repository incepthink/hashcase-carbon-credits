...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="font-poppins w-full h-screen md:bg-home-background bg-[#3addf6] bg-center  md:flex md:flex-row column items-stretch bg-cover relative overflow-hidden hidden">
        <Head>
          ...
          <div className="flex-1 flex justify-center items-center p-8">
            <div className="flex flex-col items-start">
              ...
              <p className="text-[#667085]">
                This is a FREE CLAIM for the early supporters of Hashcase as we
          ...
          <div className="w-full p-6 flex flex-col    ">
            ...
            <div>
...

              {
                //nftBalance == -1 ? <></> :
                nftBalance > 0 ? (
                  <span className="mt-2 text-[#000000] font-bold">
                    Claimed! You have {nftBalance} Hashcase Carbon Credit NFTs
                  </span>
                ) : (
                  <button
                    onClick={mintNFTToWallet}
                    className="w-full text-xl self-center px-2 py-4 rounded-md text-centers border-none outline-none cursor-pointer bg-white text-[#04A6E7] font-semibold mt-1 mb-1 transition delay-500 ease hover:-translate-y-2 active:translate-y-4"
                    style={{ fontSize: "1.25rem" }}
                  >
                    Claim NFT
                  </button>
              ...
              <div className="w-full flex justify-center items-center">
                <button
                  ...
                  className="w-full text-xl self-center px-2 py-4 rounded-md text-centers border-none outline-none cursor-pointer bg-white text-[#04A6E7] font-semibold mt-1 mb-3 transition delay-500 ease hover:-translate-y-2 active:translate-y-4"
                >
                  Place Order
                </button>
              </div>
              ...
              <Link href="https://www.hashcase.co">
                <div className="md:w-[60%] w-[80%] mx-auto self-center bg-[#0e7490] p-2 rounded-full text-white border-2 border-[#3e4eaa98] border-solid flex justify-center items-center cursor-pointer relative">
                  Powered by{" "}
                  <Image
                    className="h-5 ml-2 text-white relative"
      ...
      <div className="font-poppins w-full h-screen md:bg-home-background bg-[#3addf6] bg-center  md:flex-row column bg-cover relative overflow-hidden md:hidden items-center justify-center text-centers">
        <h1 className="font-bebas text-4xl uppercase">
          Please view on laptop!
        </h1>
      </div>
    </>
  );
