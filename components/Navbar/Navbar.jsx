...
function MobileNav({ open, setOpen, user, openDropdown, handleClick }) {
    ...
    >
      <div className="flex items-center justify-center filter drop-shadow-md bg-white h-20">
        ...
        >
          ...
          />
          <span className="text-[#04A6E7] font-ayuthaya ml-1">
            {" "}
    ...
    <nav className="relative z-50 flex filter drop-shadow-md bg-white px-4 py-4 h-20 justify-center items-center">
      ...
      <div className="md:w-3/12 w-1/2 flex items-center">
        <Link className="flex items-center text-2xl font-semibold " href="/">
          <Image
            ...
            style={{ objectFit: "contain" }}
          />
          <span className="text-[#04A6E7] ayuthaya ">
            {" "}
            Hashcase Carbon Credit
          </span>
        </Link>
      ...
      <div className="w-9/12 flex justify-end items-center">
        ...
        <div className="hidden md:flex justify-center items-center text-[#00337C] text-lg font-nunito ">
          <Link
            href="/"
            className={`mx-4 hover:scale-105 duration-150 items-center justify-center ease-in delay-150 ${
              router.pathname == "/" &&
              "underline underline-offset-[6px] decoration-[#00337C] decoration-2"
            } `}
          >
